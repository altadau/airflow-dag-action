...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                #
                "base_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/migration/2023-10-19T21-00/XOM/ESP_DATA/RAW_DONE/fromGeorge/MidlandWells/",
                "input_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/migration/2023-10-19T21-00/XOM/ESP_DATA/RAW_DONE/fromGeorge/MidlandWells/*/*.csv",
