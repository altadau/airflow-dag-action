...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                "input_s3_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/topics/xom_us_landing/sensordata/",
                "source_schema_path": "assets://schemas/schema_xom_us_kafka_sensordata.json",
                "sensor_schema_path": "assets://schemas/schema_xom_us_kafka_sensordata.json",
                #
                "hudi_id_concat_fields": ["APINumber", "NodeID", "Measurement", "RecordDateTimeUTC"],
                ...
                #
                "hudi_output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/SENSOR/LIVE/SENSORDATA/",
                "hudi_mode": "Append",
                "hudi_options": {
                    "hoodie.table.name": "XOM_US_KAFKA_SENSORDATA",
