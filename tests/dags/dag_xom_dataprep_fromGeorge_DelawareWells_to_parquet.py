...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                "base_path": "s3://322589048303-pre-prod-xom-esp-data-raw/XOM/ESP_DATA/RAW_DONE/fromGeorge/DelawareWells/",
                "input_path": "s3://322589048303-pre-prod-xom-esp-data-raw/XOM/ESP_DATA/RAW_DONE/fromGeorge/DelawareWells/*/*.csv",
                "input_schema_path": "assets://schemas/schema_xom_sensor_csv_plain.json",
                # "input_filter": "APINumber IN ('3001537272', '3001537309')",
                "output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/SENSOR/dataprep/DelawareWells/",
                "output_coalesce": 64,
