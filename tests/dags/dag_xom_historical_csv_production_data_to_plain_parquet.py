...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                "base_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/PRODUCTION/HISTORICAL/CSV_2023-05-21/",
                "input_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/PRODUCTION/HISTORICAL/CSV_2023-05-21/*/*.csv",
                "input_schema_path": "assets://schemas/schema_xom_production_csv_plain.json",
                # "input_filter": "API10 IN ('3001537271', '3001537272')",
                "output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/PRODUCTION/HISTORICAL/CSV_2023-05-21/",
                "output_coalesce": "64",
                "output_partition_by": "API10",
                "header": "false"
            },
        ),
    )
