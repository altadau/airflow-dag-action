...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                #
                "base_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/migration/2023-10-19T21-00/XOM/ESP_DATA/RAW_DONE/fromGeorge/CasingAndProductionData/",
                "input_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/migration/2023-10-19T21-00/XOM/ESP_DATA/RAW_DONE/fromGeorge/CasingAndProductionData/*/*.csv",
                "input_schema_path": "assets://schemas/schema_xom_production_csv_typed.json",
                "header": "false",
                # "input_filter": "API10 IN ('3001537272', '3001537309')",  # testing purposes

                "hudi_id_concat_fields": ["API10", "mdprawrecordaddedutc", "measurement"],
                "hudi_partition_primary_field": "API10",
                "hudi_partition_datetime_field": "mdprawrecordaddedutc",
                "hudi_partition_datetime_pattern": "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
                "hudi_output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/PRODUCTION/VERSION_14/",
                "hudi_mode": "Append",
                "hudi_options": {
                    "hoodie.table.name": "XOM_PRODUCTION",
