...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                "base_path": "s3://322589048303-pre-prod-xom-esp-data-raw/XOM/ESP_DATA/RAW_DONE/fromGeorge/MidlandWells/",
                "input_path": "s3://322589048303-pre-prod-xom-esp-data-raw/XOM/ESP_DATA/RAW_DONE/fromGeorge/MidlandWells/*/*.csv",
                "input_schema_path": "assets://schemas/schema_xom_sensor_csv_plain.json",
                # "input_filter": "APINumber IN ('3001537272', '3001537309')",
                "output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/SENSOR/dataprep/MidlandWells/",
                "output_coalesce": 64,
