...
with LeucipaDAG(
    ...
    spark_app = LeucipaEmrAddStepsOperator(
        ...
        leucipa_spark_config=LeucipaSparkConfig(
            ...
            leucipa_config={
                "input_s3_path": f"s3://{Variable.get(TENANT_XOM_US_LANDING)}/topics/xom_us_landing/productiondata/",
                "source_schema_path": "assets://schemas/schema_xom_us_kafka_productiondata.json",
                "sensor_schema_path": "assets://schemas/schema_xom_us_kafka_productiondata.json",
                #
                "hudi_id_concat_fields": ["API10", "MerrickID", "RecordDate"],
                "hudi_partition_primary_field": "API10",
                "hudi_partition_datetime_field": "RecordDate",
                "hudi_partition_datetime_pattern": "yyyy-MM-dd",
                #
                "hudi_output_path": f"s3://{Variable.get(TENANT_XOM_US_RAW)}/SENSOR/LIVE/PRODUCTIONDATA/",
                "hudi_mode": "Append",
                "hudi_options": {
                    "hoodie.table.name": "XOM_US_KAFKA_PRODUCTIONDATA",
